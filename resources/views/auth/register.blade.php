...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box" style="width: 550px; border-radius:25px; height: 550px;">
        ...
        @csrf
          ...
          <div class="form-group">
            ...
            <input id="password-confirmation" type="password" class="form-control @error('password-confirmation') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password" placeholder="Masukkan Password kembali">
